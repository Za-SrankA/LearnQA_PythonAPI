...
class TestUserAuth:
    ...
    def test_auth_user(self):
        ...
        self.user_id_from_check_method = response2.json()["user_id"]

        assert self.user_id_from_auth_method == self.user_id_from_check_method, "User id from auth method is not equal to user id from check method"
    ...
    def test_negative_auth_check (self, condition):
        ...
        assert self.user_id_from_check_method == 0,f"User authorized with condition {condition}"